  ...
  <div class="main-content-inner">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
          ...
          <li class="active"><?php echo $type; ?> Transfer Funds List</li>
        </ul><!-- /.breadcrumb -->            
    </div>
...
<div class="page-content">
  <div class="page-header-1">
      <h1 class="col-lg-3 col-sm-4 col-md-5 col-xs-7 mbl-mgbtm-5 pdg-top-10">
       ...
       <?php echo $html_data; ?> Transfer Funds List
      </h1>
        <div class="pull-right "> 
          <a href="<?php echo base_url();?>admin/available_funds/income_expense_details/<?php echo $attachment_id;?>" class="btn btn-danger btn-sm" type="button"><i class="fa fa-arrow-left fa-lg"></i> Back</a>                          
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/available_funds/transfer_funds_list/'.$attachment_id.'/'.$type); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
            </table>                                            
...
<script>
    ...
    var attachment_id= '<?php echo $attachment_id?>';
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/available_funds/all_transferfunds'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "From Payment Mode", "name":"from_payment_mode","orderable": false, "data":"from_payment_mode", "width":"0%" },
            { "title": "To Payment Mode", "name":"to_payment_mode","orderable": false, "data":"to_payment_mode", "width":"0%" },
            { "title": "Transer Amount", "name":"center","orderable": false, "data":"transfer_amount", "width":"0%" },

            { "title": "Tansaction Id", "name":"transaction_id","orderable": false, "data":"transaction_id", "width":"0%" },

            { "title": "Created By", "name":"transaction_id","orderable": false, "data":"created_by", "width":"0%" },

            { "title": "Paid date", "name":"amount_paid_date","orderable": false, "data":"created_on", "width":"0%" },
