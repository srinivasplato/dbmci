  ...
  <div class="main-content-inner">
    <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
              ...
              <li class="active">Today Incomes List</li>
            </ul><!-- /.breadcrumb -->
  ...
  <div class="page-header-1">
              <h1 class="col-lg-12 col-sm-4 col-md-5 col-xs-7 mbl-mgbtm-5 pdg-top-10">
                <i class="menu-icon blue fa fa-cart-arrow-down"></i>  
                  Incomes List --->Selected Date : <b style="color:red"> <?php echo $search_date?></b>
              </h1>
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <!-------- Search Form ---------->
             <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/daily_sheet/daily_incomes_list'.$this->uri->segment(4)); ?>"><li class="fa fa-minus icon-style"></li></a>
              </div>
            </form>
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/daily_sheet/all_daily_incomes_list_records'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Income Amount", "name":"title","orderable": false, "data":"id", "width":"0%" },
        ...
        {           
         ...
         // $(nRow).find('td:eq(2)').html(image);
          ...
          var income_details = '<b style="color:green">'+aData['amount_paid'] +'</b>';

          $(nRow).find('td:eq(3)').html(income_details);
