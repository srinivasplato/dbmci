        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="<?php echo base_url()?>admin/stockdepartment/update_record" enctype="multipart/form-data" novalidate="">
              <div class="row">
                <div class="col-lg-9 col-xs-12 col-sm-9 col-md-9 col-lg-offset-1">
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 word-brk">
                    <select class="form-contro standardSelect" id="batch_id" name="batch_ids[]"  required multiple >
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
                      <input class="form-control" placeholder="" type="text" name="stock_name" value="" id="stock_name" onkeyup="" required>
                    </div>
                  </div>
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 word-brk">
                      <input class="form-control" placeholder="" type="text" name="count" value="" id="count" onkeyup="" required="" data-parsley-id="3479">
                    </div>
                  </div>
