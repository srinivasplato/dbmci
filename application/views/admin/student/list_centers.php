	<div class="main-content">
		<div class="main-content-inner">
          ...
          <a href="<?php echo base_url();?>admin/student/list_org/<?php echo $state_id?>" class="btn btn-danger btn-sm" type="button"><i class="fa  fa-arrow-left fa-lg"></i> Back</a>                          
						...
						<div class="edu_dashboard_widgets">							
				    		<div class="row">
			    				...
			    				<div class="col-xl-12 col-lg-4 col-md-4 col-sm-12 col-12">
			    					<a href="<?php echo base_url()?>admin/student/students_list/<?php echo $state_id?>/<?php echo $org_id?>/<?php echo $center['id']?>">
				    					<div class="edu_color_boxes box_left">
				    						<div class="edu_dash_box_data">
				    						    <p><b><?php echo $center['center']; ?></b></p>
				    							   <h3><b><?php 
										    			echo $center['students_count'];
