    ...
    border-radius: 20px;background-color: #efefef;" width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                <tr>
                  ...
                  <td width="25%"><span style=" font-size:21px; color:#000; padding:5px; font-family: 'Muli', sans-serif;"> : <?php echo $student_data['student_name']; ?></span></td>
                ...
                <tr>
                  ...
                  <td><span style="font-size:21px; color:#000; padding:5px; font-family: 'Muli', sans-serif;"> : +91 <?php echo $student_data['student_mobile']; ?></span></td>
