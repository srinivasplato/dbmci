...
<div class="page-content">
  <div class="page-header-1">
      ...
      <?php if( in_array('a',$roleResponsible['general_students'])){?>
          ...
          <a href="<?php echo base_url();?>admin/nonbhatia_payments/add" class="btn btn-success btn-sm" type="button"><i class="fa fa-plus fa-lg"></i> Add Payment</a>                          
        ...
        <div class="panel-body">
          ...
          <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px; z-index:99999999"><img src='<?=base_url();?>assets/img/demo_wait.gif' width="64" height="64" /></div>
            ...
            <form id="fees_form" name="search_fees" method="post" class="pull-right">
              ...
              <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/agent_dashboard/agent_incomes_list/1'); ?>"><!-- <li class="fa fa-minus icon-style"></li> -->Back</a>
              </div>
            </form> 
            <!-------- /Search Form ---------->
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/agent_dashboard/all_records'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        "columns": [
            ...
            { "title": "Name", "name":"state","orderable": false, "data":"student_name", "width":"0%" },
