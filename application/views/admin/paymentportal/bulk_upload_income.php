				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>								 
								<a href="<?php echo site_url();?>admin/student">Bulk Upload Incomes</a>
							</li>
					...
					<div class="page-content">
						<div class="page-header-2">
							<h1 class="col-lg-4 col-md-3 col-sm-3 col-xs-12 pdg-top-10">
								<i class="menu-icon fa fa-list-ul blue"></i>Incomes
                           ...
                           <div class="pull-right ">
							...
							<a class="btn btn-success btn-sm" href="<?php echo site_url();?>admin/nonbhatia_payments/filedownload" type="button"><i class="fa fa-arrow fa-lg"></i> Download excel format </a>
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
										<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="<?php echo base_url()?>admin/nonbhatia_payments/import_bulkexcel" enctype="multipart/form-data">
							<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 formfooter text-center mgtp-btm-10">
									...
									<input type="submit" name="submit"  class="btn btm-sm btn-success btn-sm" value="submit" /> 
									 <a class="btn btn-danger btn-sm" type="edit" href="<?php echo base_url();?>admin/nonbhatia_payments">Back
									</a>
								</div>								
							</div><!-- End Row -->
							</form>
