	<div class="main-content">
		<div class="main-content-inner">
          ...
          <a href="<?php echo base_url();?>admin/expenses/states" class="btn btn-danger btn-sm" type="button"><i class="fa  fa-arrow-left fa-lg"></i> Back</a>                          
						...
						<div class="edu_dashboard_widgets">							
				    		<div class="row">
			    				...
			    				<div class="col-xl-12 col-lg-4 col-md-4 col-sm-12 col-12">
			    					<a href="<?php echo base_url()?>admin/expenses/list_centers/<?php echo $state_id?>/<?php echo $org['id']?>">
