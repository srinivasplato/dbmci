			...
			<div class="page-content">						 
				<div class="page-header">
					...
					<i class=" pull-left blue fa fa-dashboard"></i>
						List Years ---> <b style="color:red"><?php echo $state['state'];?></b>(state) ---><b style="color:red"> <?php echo $organisation['organisation_name'];?> </b>(organasation) ---><b style="color:red"> <?php echo $center['center'];?> </b>(center) 
					</h1>
					<div class="pull-right">								
						<a class="btn btn-success btn-sm" href="<?php echo site_url();?>admin/paymentview/org_center/<?php echo $state_id?>/<?php echo $org_id?>" type="button">Back </a>
						...
						<div class="edu_dashboard_widgets">							
				    		<div class="row">
			    				...
			    				<div class="col-xl-12 col-lg-4 col-md-4 col-sm-12 col-12">
			    					<a href="<?php echo base_url()?>admin/paymentview/center_years_months/<?php echo $state_id?>/<?php echo $org_id?>/<?php echo $center_id?>/<?php echo $value['year']?>">
				    					<div class="edu_color_boxes box_left">
				    						<div class="edu_dash_box_data">
				    						    <p><b>Year-<?php echo $value['year'] ?></b></p>
