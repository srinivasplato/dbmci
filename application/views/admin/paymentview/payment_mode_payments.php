			...
			<div class="page-content">						 
				<div class="page-header">
					...
					<i class=" pull-left blue fa fa-dashboard"></i>
						Payment Modes---> <b style="color:red"><?php echo $state['state'];?></b>(state) ---><b style="color:red"> <?php echo $organisation['organisation_name'];?> </b>(organasation) ---><b style="color:red"> <?php echo $center['center'];?> </b>(center) ---><b style="color:red"> <?php echo $year;?> </b>(Year) ---><b style="color:red"> <?php echo $month['month'];?> </b>(Month) 
					</h1>
					...
					<div class="sectionHolder edu_admin_right edu_dashboard_wrap">
						...
						<div class="row">
			    				...
			    				<div class="col-xl-12 col-lg-4 col-md-4 col-sm-12 col-12">
			    					<a href="<?php echo base_url()?>admin/paymentview/<?php echo $function_type?>/<?php echo $state_id?>/<?php echo $org_id?>/<?php echo $center_id?>/<?php echo $year?>/<?php echo $month_id?>/<?php echo $value['id']?>/<?php echo $type?>">
