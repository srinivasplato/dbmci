				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>								 
								<a href="<?php echo site_url();?>admin/payment_approvals">Update payments</a>
							</li>
					...
					<div class="page-content">
						<div class="page-header-2">
							<h1 class="col-lg-4 col-md-3 col-sm-3 col-xs-12 pdg-top-10">
								<i class="menu-icon fa fa-list-ul blue"></i>Update payments
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
										<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="<?php echo base_url()?>admin/nonbhatia_payments/update_record" enctype="multipart/form-data">
											<input type="hidden" name="param" value="<?php echo $type;?>">
							<div class="row">
									<div class="col-lg-9 col-xs-12 col-sm-9 col-md-9 col-lg-offset-1">
										...
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
											<select class="form-control" name="state_id" id="state_id" required="" onchange="getOrganisations(this.value)" readonly="">
									...
									<div class="row form-group frm-btm">
											...
											<div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
											<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
												<select class="form-control" name="organisation_id" id="organisation_id" required="" readonly="" onchange="getCenters(this.value)" >
									...
									<div class="row form-group frm-btm">
										...
										<div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
											<select class="form-control" name="center_id" id="center_id" required="" onchange="getCourses1(this.value)" readonly="">
									...
									<div class="row form-group frm-btm">
										...
										<div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
										<select class="form-control" name="course_id" id="course_id" required="" onchange="getbatchs(this.value)" readonly="">
					...
					<!-- <b><input class="form-control" placeholder="" type="text" name="date" readonly 
						...
						<input class="form-control" placeholder="" type="hidden" name="room_no" value="<?php echo $student_data['room_no']?>" id="room_no" onkeyup="" >
											
						<input class="form-control" placeholder="" type="hidden" name="cabin_no" value="<?php echo $student_data['cabin_no']?>" id="cabin_no" onkeyup="" >
											
						<input class="form-control" name="college_state_id" type="hidden" id="college_state_id" value="<?php echo $record['college_state_id']?>"> 

						<input class="form-control" name="college_id" type="hidden" id="college_id" value="<?php echo $record['college_id']?>"> 
