								...
								<div class="col-lg-9 col-xs-12 col-sm-9 col-md-9 col-lg-offset-1">
									<div class="row form-group frm-btm">
										...
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
											<input class="form-control" placeholder="" type="text" name="discount_name" value="<?php echo $record['discount_name'] ?>" id="discount_name" onkeyup="" required>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-lg-9 col-xs-12 col-sm-9 col-md-9 col-lg-offset-1">
									<div class="row form-group frm-btm">
										...
										<div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
											<input class="form-control" placeholder="" type="text" name="discount_percentage" value="<?php echo $record['discount_percentage'] ?>" id="discount_percentage" onkeyup="" required>
										</div>
									</div>
										<input class="form-control" type="hidden" name="id" value="<?php echo $record['id']; ?>">
								</div> 									
