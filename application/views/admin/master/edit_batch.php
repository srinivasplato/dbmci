				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>								 
								<a href="<?php echo site_url();?>admin/batchs">Batchs</a>
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
										<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="<?php echo base_url()?>admin/batchs/update_batchs" enctype="multipart/form-data">
							<div class="row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 word-brk">
                      <select class="form-control" name="center_id" id="center_id" required="" onchange="getCourses(this.value)">
                                ...
                                ?>
									...
									<div class="row form-group frm-btm">
										<div class="col-lg-3 col-sm-3 col-md-3 col-xs-5">
											<label class="input-text">Batch Name <span class="red bigger-120">*</span></label>
										</div>
										<div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
											<input class="form-control" placeholder="" type="text" name="batch_name" value="<?php echo $record['batch_name'] ?>" id="batch_name" onkeyup="" required>
										</div>
									</div>

									<div class="row form-group frm-btm">
										<div class="col-lg-3 col-sm-3 col-md-3 col-xs-3">
											<label class="input-text">Student Code<span class="red bigger-120">*</span></label>
										</div>
										<div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 word-brk">
											<b>
											<input class="form-control" placeholder="" type="text" name="student_code" value="<?php echo $record['student_code'] ?>" id="student_code" onkeyup="" required readonly>
										</b>
										</div>
									</div>
									...
									<div class="row form-group frm-btm">
										...
										<div class="col-lg-1 col-xs-1 col-sm-1 col-md-1 input-text"> : </div>
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 word-brk">
											<input class="form-control" placeholder="" type="text" name="order" value="<?php echo $record['order'] ?>" id="order" onkeyup="" required>
										</div>
									</div>
									...
									<input class="form-control date-picker" name="end_date" id="id-date-picker-1" value="<?php echo $record['end_date'] ?>" data-date-format="yyyy-mm-dd" required>
										...
										<input class="form-control" type="hidden" name="batch_id" value="<?php echo $record['id']; ?>" >
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 formfooter text-center mgtp-btm-10">
									...
									<a class="btn btn-danger btn-sm" type="edit" href="<?php echo base_url();?>admin/batchs">Back
									</a>
								</div>								
							</div><!-- End Row -->
							</form>
