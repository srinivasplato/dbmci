...
<div class="page-content">
  <div class="page-header-1">
      ...
      <?php if( in_array('a',$roleResponsible['centers'])){?>
       
          <a href="<?php echo base_url();?>admin/centers/add" class="btn btn-success btn-sm" type="button"><i class="fa fa-plus fa-lg"></i> Add </a>                          
...
<script>
    ...
    $(document).ready(function () {
        ...
        "destroy": true,
        "ajax": {
            "url": "<?php echo base_url('admin/centers/all_centers'); ?>",
            "type":"POST",
            beforeSend: function() {
        ...
        <?php if( (in_array('s',$roleResponsible['centers'])) && (in_array('e',$roleResponsible['centers'])) ){?>
        
          $(nRow).find('td:eq(6)').html(action);
        
        <?php }else if((!in_array('s',$roleResponsible['centers'])) && (in_array('e',$roleResponsible['centers'])) ){?>
           $(nRow).find('td:eq(5)').html(action);
