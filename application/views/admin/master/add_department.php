        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="<?php echo base_url()?>admin/department/update_record" enctype="multipart/form-data" novalidate="">
              <div class="row">
                <div class="col-lg-9 col-xs-12 col-sm-9 col-md-9 col-lg-offset-1">
                  ...
                  <div class="row form-group frm-btm">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 word-brk">
                      <input class="form-control" placeholder="" type="text" name="dept_name" value="" id="dept_name" onkeyup="" required>
                    </div>
                  </div>              
